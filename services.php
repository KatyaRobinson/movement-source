                        ...
                        <div id="customer-info">
                            ...
                            <form class="form-group" id="cust-contact">
                               ...
                               <!--  <label class="col-md-4 control-label" for="cust-email"> Email </label> -->
                                <div class="col-md-4">
                                     <input type="text" id="cust-email" name="email" placeholder="Email">
                                </div> 
                                <div class="col-sm-12">
                                    <textarea id="cust-message" name ="message" placeholder="Message (optional)"></textarea>
                                </div>
                                <input type="submit" value="Request appointment" id="request-appt" />
                            </form>
